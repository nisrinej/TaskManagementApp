...
const Navbar = () =>{
    ...
    return(
        ...
        <span className='md:hidden cursor-pointer' onClick={toggleNavabr}><i className="fa-solid fa-bars"></i></span>
        ...
        <div className={`absolute md:hidden right-0 top-0 bottom-0 transition ${(isNavbarOpen === true) ? 'translate-x-0' : 'translate-x-full'} bg-gray-100 shadow-md w-screen sm:w-9/12 h-screen`}>
          <div className='flex'>
            <span className='m-4 ml-auto cursor-pointer' onClick={toggleNavabr}><i className="fa-solid fa-xmark"></i></span>
          </div>
